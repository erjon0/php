      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="<?php echo $movie['image']; ?>" alt="<?php echo $movie_data['name']; ?>" class="card-img-top" style="height: 225px; width: 100%; display: block;">
            <div class="card-body">
              <h5><?php echo $movie['name']; ?></h5>
              <p class="card-text"><?php echo $movie_data['description']; ?></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="editMovie.php?id=<?php echo $movie['id']; ?>" class="btn btn-sm btn-outline-secondary">Edit</a>
                  <a href="deleteMovie.php?id=<?php echo $movie['id']; ?>" class="btn btn-sm btn-outline-secondary">Delete</a>
                </div>
