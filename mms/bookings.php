...
$sql = "SELECT movies.title, bookings.nr_tickets, bookings.date, bookings.time FROM bookings INNER JOIN movies ON bookings.movie_id = movies.id WHERE bookings.user_id = :user_id";
